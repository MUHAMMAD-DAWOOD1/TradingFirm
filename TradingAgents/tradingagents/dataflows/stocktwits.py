...
def _stocktwits_symbol(ticker: str) -> str:
    """Map crypto and metal futures to StockTwits symbol conventions."""
    base = crypto_base(ticker)
    if base:
        return f"{base}.X"
    s = ticker.strip().upper()
    metal_map = {"GC=F": "GOLD", "XAUUSD": "GOLD", "SI=F": "SILVER", "XAGUSD": "SILVER", "CL=F": "OIL"}
    return metal_map.get(s, s)
